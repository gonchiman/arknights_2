...
export function SkillClassificationContent({
  skill,
  override,
  ...
  const getTabId = (tab: DetailTab) => `${tabIdPrefix}-detail-tab-${tab}`
  const getPanelId = (tab: DetailTab) => `${tabIdPrefix}-detail-panel-${tab}`
  ...
  return (
    <div className="skill-classification-content">
      ...
      <div
        id={getPanelId('summary')}
        className="detail-tab-panel"
        role="tabpanel"
        aria-labelledby={getTabId('summary')}
        hidden={activeTab !== 'summary'}
      >
        <section className="overview-section">
          <Heading>スキル説明</Heading>
          <p className="description">{description || '説明文なし'}</p>
        </section>
      ...
      <div
        id={getPanelId('classification')}
        className="detail-tab-panel"
        role="tabpanel"
        aria-labelledby={getTabId('classification')}
...
function SummaryDimension<T>({ title, labels, colors, field, heading: Heading }: SummaryDimensionProps<T>) {
  return (
