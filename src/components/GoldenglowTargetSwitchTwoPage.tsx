  ...
  const openImageSaveDialog = () => {
    ...
    setImageExport({
      ...
      snapshot: {
        ...
        metric, baselineId, digits, chartKind, barMode, yAxisMode, hideBaseline, barHps: [...barHps], title: `ゴールデングロー：${chartLabel}`,
        ...
        <GoldenglowTargetSwitchHpResults series={visibleSeries} enemyHps={shownHps} metric={metric} baselineId={baselineId}
          ...
          <div className="gg2-chart-area" aria-busy={running}>
            <GoldenglowTargetSwitchHpChart series={displaySeries} maxHp={shownHps.at(-1) ?? 30000}
              ...
              chartKind={chartKind} barMode={barMode} yAxisMode={yAxisMode} manualYAxisRange={manualYAxisRange} barHps={barHps} hideBaseline={hideBaseline} onPlotWidthChange={setChartPlotWidth} />
