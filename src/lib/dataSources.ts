...
export const DATA_SOURCE_URLS = {
  ...
  handbookTeam: `${EXCEL_BASE}/handbook_team_table.json`,
...
export const DATA_SOURCE_GROUPS = [
  {
    ...
    sources: [
      ...
      {
        id: 'handbook-team-table',
        file: 'handbook_team_table.json',
        url: DATA_SOURCE_URLS.handbookTeam,
        description: 'オペレーターの国・組織・チームのIDを、日本語の所属陣営名に変換します。',
        usage: ['Operator Database'],
        access: ['runtime'],
        linkLabel: 'handbook_team_table.json を開く',
      },
    ],
  },
  {
    ...
    sources: [
      {
        ...
        usage: ['敵データベース', '敵の統計分析', '登場ステージ数の事前集計'],
