...
const OPERATOR_EFFECT_DEFINITIONS: OperatorEffectDefinition[] = [
  {
    ...
    sourceKind: 'TRAIT',
    talentIndex: null,
    blackboardKey: 'init_atk_scale',
    label: '浮遊ユニットの初回倍率',
    status: 'NO_DIRECT_EFFECT',
    reason: '本体の通常攻撃倍率には加えず、オペレーター固有出力の浮遊ユニット計算へ反映します。',
    scope: 'ATTACK',
    action: 'NONE',
    directImpact: true,
  ...
  },
  {
    ...
    sourceKind: 'TALENT',
    talentIndex: 0,
    blackboardKey: 'attack@atk_scale_2',
    label: '電流暴走の爆発倍率',
    status: 'NO_DIRECT_EFFECT',
    reason: '通常攻撃の倍率には加えず、スキル中の爆発1回としてオペレーター固有出力へ反映します。',
    scope: 'ATTACK',
    action: 'NONE',
    directImpact: true,
    formatValue: formatRatioPercent,
